                    ...
                    <?php echo method_field('PUT'); ?>
                        <div class="card-body">
                            <div class="color-box">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($escolas->nome); ?>" name="nome" placeholder="nome da escola">
                            </div></br>
                            <div class="color-box">
                                <label for="localizacao">Localização</label>
                                <input type="text" class="form-control" value="<?php echo e($escolas->localizacao); ?>" name="localizacao" placeholder="localizacao">
                            </div><p></p></br>
                            <div class="color-box">
