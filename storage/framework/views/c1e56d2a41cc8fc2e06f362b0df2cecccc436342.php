		...
		<div class="row">
		  <div class="col-sm-12">
			<div class="card">
			  ...
			  <form action="<?php echo e(route('rota-store')); ?>" method="POST">
              <?php echo csrf_field(); ?>
				<div class="card-body">
					<div class="color-box">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\sgfte\theme\resources\views/admin/rota/create.blade.php ENDPATH**/ ?>