                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="color-box">
                            ...
                            <input type="text" class="form-control" name="modelo" id="exampleFormControlInput1" placeholder="modelo">
                        </div></br>
                        <div class="color-box">
                            <label for="exampleFormControlInput1">Placa</label>
                            <input type="text" class="form-control" name="placa" id="exampleFormControlInput1" placeholder="placa">
                        </div></br>
                        <div class="color-box">
                            <label for="exampleFormControlInput1">Ano de Fabrico</label>
                            <input type="number" class="form-control" name="ano" id="exampleFormControlInput1" placeholder="fabrico">
                        </div></br>
                        <div class="color-box">
                            <label for="exampleFormControlInput1">Capacidade do Veículo</label>
                            <input type="number" class="form-control" name="capacidade" id="exampleFormControlInput1" placeholder="Capacidade">
                        </div></br>
                        <div class="row">
