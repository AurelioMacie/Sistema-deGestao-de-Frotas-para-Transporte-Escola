                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="color-box">
                            ...
                            <input type="text" class="form-control" name="modelo" value="{{ $veiculos->modelo }}" id="exampleFormControlInput1" required="">
                        </div></br>
                        <div class="color-box">
                            <label for="exampleFormControlInput1">Placa</label>
                            <input type="text" class="form-control" name="placa" value="{{ $veiculos->placa }}" id="matricula" required="">
                        </div></br>
                        <div class="color-box">
                            <label for="exampleFormControlInput1">Ano de Fabrico</label>
                            <input type="number" class="form-control" name="ano" value="{{ $veiculos->ano }}" id="fabrico" required="">
                        </div></br>
                        <div class="color-box">
                            <label for="exampleFormControlInput1">Capacidade do Veículo</label>
                            <input type="number" class="form-control" name="capacidade" value="{{ $veiculos->capacidade }}" id="cap" required="">
                        </div></br>
                        <div class="row">
